...
if (viewBy === “week”) {
// extract week number from “week2 (04 Jan - 10 Jan)” or bare “W2”
...
const pagedTiles = filteredTiles.slice(tileIndex*TILES_PER_PAGE, tileIndex*TILES_PER_PAGE+TILES_PER_PAGE);
          ...
          <div style={{display:"flex",paddingLeft:22,marginTop:3}}>
            {gdates.map((d,i)=>(
              <span key={String(d)} style={{
                ...
                {xAxisLabel(d, i, gdates.length, tileViewBy||viewBy)}
              </span>
            ))}
          </div>
        </>
