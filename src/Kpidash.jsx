...
if (contractualOn && bonusOn) return hasC && hasB;
if (contractualOn) return hasC;
if (bonusOn)       return hasB;
return true;
}
...
/* ── filtered data (useMemo — instant, no API call) ─────── */
...
```
    ...
    <div style={{ display: "flex", gap: 12, alignItems: "stretch" }}>
      ...
      <div style={{
        ...
        <div className="filter-row">
          ...
          <div style={{
            ...
            alignSelf: "stretch", margin: "0 4px", flexShrink: 0,
          }} />

          {/* ── Contractual toggle ── */}
          <div className="filter-col" style={{ flex: "0 0 auto", alignItems: "center" }}>
            <ToggleSwitch
              label="Contractual"
              value={contractualOn}
      ...
      <div style={{
        ...
        <span style={{ fontSize: 11, fontWeight: 600, color: "#444", textAlign: "center" }}>
          View By
        </span>
        <Segmented
          options={[
...
/* ═══════════════════════════════════════════════════════════
renderFilterCol — dropdown inside a flex col, no added ALL
═══════════════════════════════════════════════════════════*/
