...
return(
  <div className="kpi-tile" key={label}>
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:4}}>
      <div style={{fontSize:12,fontWeight:700,color:"#475569",flex:1,marginRight:8,lineHeight:1.35,wordBreak:"break-word"}}>{label}</div>
      {target!=="-"&&(
