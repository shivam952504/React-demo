...
tenure_unit: filters.tenure_unit,  // array
}), [filters]);

/* debouncedPayload — what actually gets sent to API */
const debouncedPayload = useMemo(() => ({
year_type:   (debouncedFilters || filters).year_type,
year:        (debouncedFilters || filters).year,
month:       (debouncedFilters || filters).month,
geo:         (debouncedFilters || filters).geo,
program:     (debouncedFilters || filters).program,
lob:         (debouncedFilters || filters).lob,
supervisor:  (debouncedFilters || filters).supervisor,
tenure_unit: (debouncedFilters || filters).tenure_unit,
}), [debouncedFilters]);
