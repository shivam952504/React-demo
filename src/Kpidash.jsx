...
```
    ...
    <div className="kfi" style={{
      ...
      <div style={{display:"flex",alignItems:"center",gap:18,marginBottom:16,flexWrap:"nowrap"}}>
        ...
        {viewBy==="day" && (
          <div style={{display:"flex",flexDirection:"column",gap:5}}>
            <span style={{fontSize:10,fontWeight:700,color:"#64748b",letterSpacing:"1px",textTransform:"uppercase"}}>Month</span>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:5}}>
          <span style={{fontSize:10,fontWeight:700,color:"#64748b",letterSpacing:"1px",textTransform:"uppercase"}}>View By</span>
      ...
      <div style={{display:"flex",gap:14,flexWrap:"nowrap",alignItems:"flex-end"}}>
        {[
          ...
          <div key={key} style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:5}}>
            <span style={{fontSize:10,fontWeight:700,color:"#64748b",letterSpacing:"1px",textTransform:"uppercase"}}>{label}</span>
